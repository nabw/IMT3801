...
\begin{enumerate}
    ...
    \item Demuestre que una forma bilineal que satisface las hipótesis de Lax-Milgram, también satisface las de Lax-Milgram generalizado (o condiciones de Ne\v cas-Babuska-Brezzi). 

    \item inf-sup de saddle point satisface Lax-Milgram general.
