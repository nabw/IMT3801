...
The standard way of approximating second order derivatives is that of using a finite difference approximation twice. It is given by the following: 
    $$ f''(x) \approx D^+(f')(x)\frac{}{h}
[... derive classical formula using $D^+, D^-$, and show they commute. ]

\subsection{Numerical validations}
[... Show some simple python/julia code for computing D matrices and apply them to different functions. Compare all variants of differentiation.]

\subsection{Order of convergence}
[... Study theoretically, compute real numbers in section at the end of this section]
