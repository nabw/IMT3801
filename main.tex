...
We now simply show the fundamental FEM bases and the related interpolation operators that we will use to recover most convergence estimates. We follow the presentation given in \cite{monk2003finite}. 
...
This space is conforming in $H(\curl)$. In addition, we also get some nice intecrpolation properties. 
    \begin{theorem}[$H(\curl)$ interpolation]
        \begin{itemize}
